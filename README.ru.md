...
Функция может зависит и от предыдущих значений её зависимостей:
...
Функция из одного регистра можен зависит от функций / переменных из других регистров:
...
Мы также можем зарегистрировать функцию / перменную вне регистра, если использовать `Registrino` вместо объекта регистра:
